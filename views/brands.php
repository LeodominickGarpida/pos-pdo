                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="p-20">
                            ...
                            <h4 class="header-title m-t-0">Brands</h4>
                            <p class="text-muted font-13 ">
                                you can add, edit and update brands here.
                            </p>

                            <div class="m-b-20">
                                <h6 class="font-14 mt-4" id="brands-form-title">Add New Brand</h6>
                                <form action="../controllers/brands/create.php" method="post" class="form-validation" id="brands-form-add">
                                    <div class="form-group">
                                        <label for="brand_name">Brand<span class="text-danger">*</span></label>
                                        <input type="text" name="brand_name" placeholder="Enter new category" class="form-control" id="brand_name">
                                    ...
                                    <tbody id="tb">
                                        <tr>
                                            <?php foreach ($result as $row) {?>
                                                ...
                                                <td>
                                                    <a id="<?php echo $row['brand_id']?>" class="btn btn-icon btn-default brands-edit-data"> <i class=" mdi mdi-pencil"></i> </a>
                                                    <a id="<?php echo $row['brand_id']?>" class="btn btn-icon btn-default brands-remove-data"> <i class="mdi mdi-delete-forever"></i> </a>
                                                </td>
                                        </tr>
                                            <?php }?>
                                    </tbody>
